...
CREATE TABLE ftn_macket_records (
...
CREATE TABLE ftn_macket_records_2023 PARTITION OF ftn_macket_records 
FOR VALUES FROM ('2023-01-01 00:00:00') TO ('2023-12-31 23:59:59');

CREATE TABLE ftn_macket_records_2024 PARTITION OF ftn_macket_records 
